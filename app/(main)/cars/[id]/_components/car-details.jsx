    ...
    if (navigator.share) {
      navigator
        .share({
          ...
          text: `Check out this ${car.year} ${car.make} ${car.model} on Vechile!`,
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-5/12">
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Vechile Car Loan Calculator</DialogTitle>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium">Vechile Motors</h4>
